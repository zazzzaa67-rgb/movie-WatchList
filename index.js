...
if(searchList){
    ...
    function render(){
        ...
        for(let item of searchListArr){
            // تشييك إذا كان الفيلم متضاف أصلاً في الـ Watchlist عشان الزرار يظهر مقفول جاهز
    ...
    searchList.addEventListener("click" ,e=>{
        ...
        if(targetButton){
            ...
            // تأكيد بصري فوري للمستخدم إن الفيلم اتضاف بنجاح
...
if (sendBtn && messages && aiInput) {
    sendBtn.addEventListener("click", async function() {
        ...
        try {
            const res = await fetch("https://movie-watch-list-virid.vercel.app/api/chat", {
                method: "POST",
